...
public class OTWinRMNodeExecutor implements NodeExecutor, Describable {
    ...
    public static final String CONFIG_CMD_CMD = "CMD";
    public static final String CONFIG_CMD_POWERSHELL = "PowerShell";
    public static final String DEFAULT_CMD_TYPE = CONFIG_CMD_CMD;
    ...
    static final Description DESC = DescriptionBuilder.builder()
            ...
            .property(PropertyUtil.select(CONFIG_CMD_TYPE, "Command type",
                    "Command type to use: CMD, Powershell",
                    true, DEFAULT_CMD_TYPE, Arrays.asList(CONFIG_CMD_CMD, CONFIG_CMD_POWERSHELL)))
    ...
    public NodeExecutorResult executeCommand(final ExecutionContext context, final String[] command,
        ...
        String cmdType = options.get(WINRM_CMD_TYPE);
    ...
    protected CmdLine buildCommandLine(String[] command, String OptionCmdLine) {
        if (OptionCmdLine.equals(CONFIG_CMD_POWERSHELL))
